    ...
    async handler(chatUpdate) {
        ...
        try {
            ...
            esteh: 0,
                ...
                if (akinator) {
                    if (!akinator.sesi) akinator.sesi = false
                   if (!akinator.server) akinator.server = null
                    if (!akinator.frontaddr) akinator.frontaddr = null
                    if (!akinator.session) akinator.session = null
                    if (!akinator.signature) akinator.signature = null
                    if (!akinator.question) akinator.question = null
                    if (!akinator.progression) akinator.progression = null
                    if (!akinator.step) akinator.step = null
                    if (!akinator.soal) akinator.soal = null
                } else
                    global.db.data.users[m.sender].akinator = {
                        sesi: false,
                        server: null,
